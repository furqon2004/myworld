...
*/
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
      ...
      return a !== void 0
        ...
        : F.querySelector
          ? (a = F.querySelector("script[nonce]"))
            ? ((a = a.nonce || a.getAttribute("nonce") || ""), a && a === String(a) && a.match(Aa) ? (M.nonce = a) : (M.nonce = null))
            : null
          : null;
    },
    Ea = function (a) {
  ...
  if (Z && Z.createPolicy)
    try {
      Ka = Z.createPolicy("gapi#gapi", { createHTML: t, createScript: t, createScriptURL: t });
    } catch (a) {
  ...
  window.gapi.load("", {
    callback: window["__iframefcb406326"],
    _c: {
      ...
      jsl: {
        ...
        h: "m;/_/scs/abc-static/_/js/k=gapi.lb.id.N8NDPA2avog.O/d=1/rs=AHpOoo8R2J3XzUfjs9L0jPoJkZkeAVlq0g/m=__features__",
